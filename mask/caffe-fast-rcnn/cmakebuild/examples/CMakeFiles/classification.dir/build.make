...
examples/CMakeFiles/classification.dir/cpp_classification/classification.cpp.o: ../examples/cpp_classification/classification.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/CMakeFiles/classification.dir/cpp_classification/classification.cpp.o"
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/classification.dir/cpp_classification/classification.cpp.o -c /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/examples/cpp_classification/classification.cpp
...
examples/CMakeFiles/classification.dir/cpp_classification/classification.cpp.i: cmake_force
	...
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/examples/cpp_classification/classification.cpp > CMakeFiles/classification.dir/cpp_classification/classification.cpp.i
...
examples/CMakeFiles/classification.dir/cpp_classification/classification.cpp.s: cmake_force
	...
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/examples/cpp_classification/classification.cpp -o CMakeFiles/classification.dir/cpp_classification/classification.cpp.s
...
examples/cpp_classification/classification: examples/CMakeFiles/classification.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable cpp_classification/classification"
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/classification.dir/link.txt --verbose=$(VERBOSE)
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples && ln -sf /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples/cpp_classification/classification /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples/cpp_classification/classification.bin
...
examples/CMakeFiles/classification.dir/clean:
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples && $(CMAKE_COMMAND) -P CMakeFiles/classification.dir/cmake_clean.cmake
.PHONY : examples/CMakeFiles/classification.dir/clean

examples/CMakeFiles/classification.dir/depend:
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/examples /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples/CMakeFiles/classification.dir/DependInfo.cmake --color=$(COLOR)
