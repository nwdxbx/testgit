...
examples/CMakeFiles/convert_mnist_siamese_data.dir/siamese/convert_mnist_siamese_data.cpp.o: ../examples/siamese/convert_mnist_siamese_data.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/CMakeFiles/convert_mnist_siamese_data.dir/siamese/convert_mnist_siamese_data.cpp.o"
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/convert_mnist_siamese_data.dir/siamese/convert_mnist_siamese_data.cpp.o -c /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/examples/siamese/convert_mnist_siamese_data.cpp
...
examples/CMakeFiles/convert_mnist_siamese_data.dir/siamese/convert_mnist_siamese_data.cpp.i: cmake_force
	...
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/examples/siamese/convert_mnist_siamese_data.cpp > CMakeFiles/convert_mnist_siamese_data.dir/siamese/convert_mnist_siamese_data.cpp.i
...
examples/siamese/convert_mnist_siamese_data: examples/CMakeFiles/convert_mnist_siamese_data.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable siamese/convert_mnist_siamese_data"
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/convert_mnist_siamese_data.dir/link.txt --verbose=$(VERBOSE)
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples && ln -sf /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples/siamese/convert_mnist_siamese_data /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/examples/siamese/convert_mnist_siamese_data.bin
