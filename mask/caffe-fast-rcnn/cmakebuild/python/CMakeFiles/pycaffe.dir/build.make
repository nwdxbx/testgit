...
python/CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.o: ../python/caffe/_caffe.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object python/CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.o"
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/python && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.o -c /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/python/caffe/_caffe.cpp
...
python/CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.i: cmake_force
	...
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/python && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/python/caffe/_caffe.cpp > CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.i
...
python/CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.s: cmake_force
	...
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/python && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/python/caffe/_caffe.cpp -o CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.s
...
lib/_caffe.so: python/CMakeFiles/pycaffe.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX shared library ../lib/_caffe.so"
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/python && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/pycaffe.dir/link.txt --verbose=$(VERBOSE)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "Creating symlink /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/python/caffe/_caffe.so -> /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/lib/_caffe.so"
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/python && ln -sf /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/lib/_caffe.so /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/python/caffe/_caffe.so
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/python && /usr/bin/cmake -E make_directory /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/python/caffe/proto
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/python && touch /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/python/caffe/proto/__init__.py
	cd /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/python && cp /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/cmakebuild/include/caffe/proto/*.py /work/dev/experiments/py-mask-rcnn/caffe-fast-rcnn/python/caffe/proto/
