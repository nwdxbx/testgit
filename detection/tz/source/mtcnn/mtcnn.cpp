...
MTCnn::MTCnn()
{
    ...
    PNet_.reset(new caffe::Net<float>((proto_model_dir + "/det1_p"), caffe::TEST,"B743382C96DB85858FF65AE97DF98970","802030C17462D3E3"));
    PNet_->CopyTrainedLayersFrom(proto_model_dir + "/det1_c");

    RNet_.reset(new caffe::Net<float>((proto_model_dir + "/det2_p"), caffe::TEST,"B743382C96DB85858FF65AE97DF98970","802030C17462D3E3"));
    RNet_->CopyTrainedLayersFrom(proto_model_dir + "/det2_c");

    ONet_.reset(new caffe::Net<float>((proto_model_dir + "/det3_p"), caffe::TEST,"B743382C96DB85858FF65AE97DF98970","802030C17462D3E3"));
    ONet_->CopyTrainedLayersFrom(proto_model_dir + "/det3_c");
}
