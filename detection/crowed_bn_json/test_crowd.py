...
import numpy as np
import sys 
sys.path.append('/work/project/caffe-stn/python')
...
mae = 0.0
mse = 0.0
output_dir = '/work2/project/crowed_count/test/output/'
gt_count_list =[]
et_count_list =[]
data_path = '/work2/project/crowed_count/test/images_2/'
label_path = '/work2/project/crowed_count/test/ground_truth_csv_2/'
filelist = os.listdir(data_path)

#attrNet = caffe.Net("/work2/project/crowed_count/crowd_deploy.prototxt", "/work2/project/crowed_count/snapshot/crowd_iter_f_38000.caffemodel", caffe.TEST)
attrNet = caffe.Net("/work2/project/crowed_count/crowd_deploy_nobn.prototxt", "/work2/project/crowed_count/model_iter_227500.caffemodel", caffe.TEST)
...
f = open('/work2/project/crowed_count/test/results.txt', 'w') 
