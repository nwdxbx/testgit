...
parser.add_argument('--mx-model',    type=str, default='/media/e/FrameWork/insightface/models/model-r50-128/model-r50')
parser.add_argument('--mx-epoch',    type=int, default=271)
parser.add_argument('--cf-prototxt', type=str, default='/media/e/FrameWork/insightface/models/model-r50-128/model.prototxt')
parser.add_argument('--cf-model',    type=str, default='/media/e/FrameWork/insightface/models/model-r50-128/model.caffemodel')
