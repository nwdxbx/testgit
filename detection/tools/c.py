...
backImgs = os.listdir('/media/f/src_data/Face/1207/back')
degree90Imgs = os.listdir('/media/f/src_data/Face/1207/degree90')
frontImgs = os.listdir('/media/f/src_data/Face/1207/front')
sideImgs = os.listdir('/media/f/src_data/Face/1207/sideface')

labdir = '/media/f/src_data/Face/1207/labels'
dstdir = '/media/f/src_data/Face/realface/file_txt'
...
for img in jpegImgs:
    ...
    for line in lines:
        ...
        if str(arrayline[0]) == '0' or str(arrayline[0]) == '1':
            ...
            strline = str(arrayline[0]) + ' ' + str(x) + ' ' + str(y) + ' ' + str(w) + ' ' + str(h) + '\n'
