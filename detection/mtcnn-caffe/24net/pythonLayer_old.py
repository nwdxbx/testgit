...
class BatchLoader(object):
    def __init__(self,cls_list,roi_list,pts_list,net_side,cls_root,roi_root,pts_root):
        ...
        if imdb_exit:
            fid = open('/media/ffh/f85082d9-0526-4d9a-89b4-61594dbaa936/result/24/cls.imdb','r')
    ...
    if imdb_exit:
        fid = open('/media/ffh/f85082d9-0526-4d9a-89b4-61594dbaa936/result/24/roi.imdb','r')
        ...
        if imdb_exit:
            ...
            for line in lines:
                ...
                words[5] = str(float(words[5])/w)
                words[6] = str(float(words[6])/h)
                words[7] = str(float(words[7])/w)
                words[8] = str(float(words[8])/h)
                words[9] = str(float(words[9])/w)
                words[10] = str(float(words[10])/h)
                im = np.swapaxes(im, 0, 2)
                im -= self.mean
                label    = -1
                roi      = [-1,-1,-1,-1]
