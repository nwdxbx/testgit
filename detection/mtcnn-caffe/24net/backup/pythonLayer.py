...
class Data_Layer_train(caffe.Layer):
    def setup(self, bottom, top):
        ...
        cls_root = '/media/ffh/f85082d9-0526-4d9a-89b4-61594dbaa936/mtcnn/data/'
        roi_root = '/media/ffh/f85082d9-0526-4d9a-89b4-61594dbaa936/mtcnn/data/'
        pts_root = '/home/ffh/work/project/mtcnn-caffe/prepare_data/img_align_celeba/'
...
class BatchLoader(object):
    def __init__(self,cls_list,roi_list,pts_list,net_side,cls_root,roi_root,pts_root):
        ...
        if imdb_exit:
            #fid = open('/media/ffh/f85082d9-0526-4d9a-89b4-61594dbaa936/result/24/pts.imdb','r')
...
class pts_filter_Layer(caffe.Layer):
    ...
    def reshape(self,bottom,top):
        ...
        self.N = len(self.valid_index)
        top[0].reshape(len(bottom[1].data), 10)
        top[1].reshape(len(bottom[1].data), 10)
