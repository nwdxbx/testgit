...
class BatchLoader(object):
    def __init__(self,cls_list,roi_list,pts_list,net_side,cls_root,roi_root,pts_root):
        ...
        if imdb_exit:
            ...
            fid = open('/media/ffh/ef830c69-62e9-4b22-8e2a-bc0c289b7e41/mtcnn/data/48/midimdb/cls.imdb','r')
        ...
        if imdb_exit:
            ...
            fid = open('/media/ffh/ef830c69-62e9-4b22-8e2a-bc0c289b7e41/mtcnn/data/48/midimdb/roi.imdb','r')
        ...
        if imdb_exit:
            ...
            fid = open('/media/ffh/ef830c69-62e9-4b22-8e2a-bc0c289b7e41/mtcnn/data/48/midimdb/pts.imdb','r')
