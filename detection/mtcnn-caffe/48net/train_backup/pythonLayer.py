...
class BatchLoader(object):
    def __init__(self,cls_list,roi_list,pts_list,net_side,cls_root,roi_root,pts_root):
        ...
        if imdb_exit:
            fid = open('/media/ffh/f85082d9-0526-4d9a-89b4-61594dbaa936/mtcnn/data/48/cls.imdb','r')
        ...
        if imdb_exit:
            fid = open('/media/ffh/f85082d9-0526-4d9a-89b4-61594dbaa936/mtcnn/data/48/roi.imdb','r')
    ...
    if imdb_exit:
        fid = open('/media/ffh/f85082d9-0526-4d9a-89b4-61594dbaa936/mtcnn/data/48/pts.imdb','r')
