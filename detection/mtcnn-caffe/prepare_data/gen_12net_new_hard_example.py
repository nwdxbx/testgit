...
caffemodel = '12netnew.caffemodel'
...
neg_save_dir  = "/media/ffh/f85082d9-0526-4d9a-89b4-61594dbaa936/mtcnn/data/change/24/negative"
...
for annotation in annotations:
    ...
    for i in neg_keep:
        ...
        f2.write("%s/negative/%s"%(image_size, neg_idx) + ' 0\n')
        cv2.imwrite(save_file, resized_im)
        neg_idx += 1
