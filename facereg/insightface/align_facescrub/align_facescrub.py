...
def parse_arguments(argv):
    ...
    parser.add_argument('--input-dir', type=str, help='Directory with unaligned images.',default='/media/f/src_data/Face/FaceRecognitionDataSets/megface_src')
    parser.add_argument('--output-dir', type=str, help='Directory with aligned face thumbnails.',default='/media/f/src_data/Face/FaceRecognitionDataSets/megface_src/facescrub_aligned_112x96')
