...
def load_bin(path):
  with open(path, 'rb') as f:
    ...
    feature = np.full( (feature_dim,), 0.0, dtype=np.float32)
...
def main(args):
  ...
  for k in noises:
    ...
    g = np.zeros( (feature_dim,), dtype=np.float32)
...
def parse_arguments(argv):
  ...
  parser.add_argument('--suffix', type=str, help='', default='softmaxtriploss_112x112')
  parser.add_argument('--algo', type=str, help='', default='')
  parser.add_argument('--megaface-lst', type=str, help='', default='/media/f/src_data/Face/FaceRecognitionDataSets/megface_src/megaface_mtcnnaligned/lst')
  parser.add_argument('--facescrub-lst', type=str, help='', default='/media/f/src_data/Face/FaceRecognitionDataSets/megface_src/112x112/lst')
  parser.add_argument('--megaface-feature-dir', type=str, help='', default='/media/f/src_data/Face/FaceRecognitionDataSets/megface_src/devkit/tools/data/LResNet100E/MegaFace_features')
  parser.add_argument('--facescrub-feature-dir', type=str, help='', default='/media/f/src_data/Face/FaceRecognitionDataSets/megface_src/devkit/tools/data/LResNet100E/FaceScrub_features')
  ...
  parser.add_argument('--megaface-feature-dir-out', type=str, help='', default='/media/f/src_data/Face/FaceRecognitionDataSets/megface_src/devkit/tools/data/LResNet100E/MegaFace_features_cm')
  parser.add_argument('--facescrub-feature-dir-out', type=str, help='', default='/media/f/src_data/Face/FaceRecognitionDataSets/megface_src/devkit/tools/data/LResNet100E/FaceScrub_features_cm')
