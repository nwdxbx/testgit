...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='transpose_param', full_name='caffe.LayerParameter.transpose_param', index=68,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ctc_loss_param', full_name='caffe.LayerParameter.ctc_loss_param', index=70,
